...
model_params = {
    ...
    'width': 141,
    'height': 141,
    'init_infected': UserSettableParameter('slider', 'Initial infected people(%)', 0.000144, 0, 0.000001, 0.00001),
    'infection_period': 14,
    'immunity_period': 60,
...
class CovidModel(Model):
    ...
    def infected(self):
        agents = self.schedule.agents
        # infected = [a for a in agents if ((a.status == AgentStatus.infected)  and (self.schedule.time - a.infection_day) == 1)]
